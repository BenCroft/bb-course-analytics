...
ggplot(tmp, aes(x = SISGradeLetter, y = CourseAccessMinutes/60, fill = SISGradeLetter)) +
  geom_boxplot() + 
...
ggplot(tmp, aes(x = SISGradeLetter, y = ForumPostCharacters, fill = SISGradeLetter)) +
  geom_boxplot() + 
  geom_jitter(color = "black", width = 0.1, alpha = 0.8, size = 1) +
  scale_fill_viridis_d() +
  my_theme() +
...
ggplot(tmp, aes(x = FirstGen, y = CourseAccessMinutes/60, fill = FirstGen)) +
  geom_boxplot() + 
  geom_jitter(color = "black", width = 0.1, alpha = 0.8, size = 1) +
  scale_fill_viridis_d() +
  my_theme() +
...
ggplot(tmp, aes(x = FirstGen, y = CourseAccesses, fill = FirstGen)) +
  geom_boxplot() + 
  geom_jitter(color = "black", width = 0.1, alpha = 0.8, size = 1) +
  scale_fill_viridis_d() +
  my_theme() +
...
ggplot(tmp, aes(x = FirstGen, y = ForumPostCharacters, fill = FirstGen)) +
  geom_boxplot() + 
  geom_jitter(color = "black", width = 0.1, alpha = 0.8, size = 1) +
  scale_fill_viridis_d() +
  my_theme() +
