...
```{r}
ifelse(nchar(courseItemStudentSummary$CourseItem) > 13, paste0(strtrim(courseItemStudentSummary$CourseItem, 10), '...'), courseItemStudentSummary$CourseItem)
```
