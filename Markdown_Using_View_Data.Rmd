...
```{r}
mod_PlansGrade <- lm(ClassGrade ~ Plan10..BIOL + Plan10..CJ.MIN + Plan10..FAMSTD.MIN + Plan10..HEALTHSCST + 
                       Plan10..HTHSCI.UND + Plan10..KINES.BS + Plan10..Plan.w.low.count + Plan10..PRE.BUS + Plan10..PRE.CJ + 
                       Plan10..PRE.NURS + Plan10..PRE.RADSCI + Plan10..PSYCH.BS + Plan10..PSYCH.MIN + 
                       Plan10..RADSCI.BS + Plan10..SPANSH.MIN + Plan10..UNIV.UND,
           data = tmp)
...
```{r}
mod_PlansLikelihood <- glm(as.factor(SuccessIndicator) ~ Plan10..BIOL + Plan10..CJ.MIN + Plan10..FAMSTD.MIN + Plan10..HEALTHSCST + 
                       Plan10..HTHSCI.UND + Plan10..KINES.BS + Plan10..Plan.w.low.count + Plan10..PRE.BUS + Plan10..PRE.CJ + 
                       Plan10..PRE.NURS + Plan10..PRE.RADSCI + Plan10..PSYCH.BS + Plan10..PSYCH.MIN + 
                       Plan10..RADSCI.BS + Plan10..SPANSH.MIN + Plan10..UNIV.UND,
